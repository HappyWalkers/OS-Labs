...
//        cprintf("sched_yield: no runnable environments found, but the current environment is still running\n");
        env_run(curenv);
    }

	// sched_halt never returns
//    cprintf("sched_yield: no runnable environments found, halting the cpu\n");
	sched_halt();
}
